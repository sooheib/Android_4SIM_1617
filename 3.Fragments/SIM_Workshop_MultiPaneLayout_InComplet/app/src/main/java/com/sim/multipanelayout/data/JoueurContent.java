...
public class JoueurContent {
	...
	static {
		...
		addItem(new JoueurItem("7", "17","J�R�ME BOATENG","DEFENCE",R.drawable.small_boteng,R.drawable.big_boateng,"3 September 1988 in Berlin","Virgo","Boa","1.92 m / 90 kg","Single (twin daughters Soley and Lamia)","Secondary school","Meeting friends, music, tennis, travelling"));	
		...
		addItem(new JoueurItem("12", "7","FRANCK RIB�RY","MIDFIELD",R.drawable.small_ribery,R.drawable.big_ribery,"7 April 1983 in Boulogne-sur-Mer (France)","Aries","Flagada","1.70 m / 72 kg / 42","Married (partner Wahiba, daughters Hiziya and Shahinez, son Salif)","Secondary modern","Family, tennis, motorbikes"));		
		addItem(new JoueurItem("13", "8","JAVIER MART�NEZ","MIDFIELD",R.drawable.small_martinez,R.drawable.big_martinez,"2 September 1988 in Estella (Spain)","Virgo","Javi","1.90 m / 81 kg / 45","Single (partner Maria)","Grammar school","Basketball, cinema, music, meeting friends"));
		...
		addItem(new JoueurItem("16", "19","MARIO G�TZE","MIDFIELD",R.drawable.small_goetze,R.drawable.big_goetze,"3 June 1992 in Memmingen","Gemini","-","1.76 m / 64 kg","","",""));	
		...
		addItem(new JoueurItem("24", "20","PATRICK WEIHRAUCH","FORWARD",R.drawable.small_weihrauch,R.drawable.big_weihrauch,"3 March 1994 in Gr�felfing","Pisces","Olchi","1.81 m / 73 kg / 43","Single","Secondary school","Music, meeting with friends, Playstation"));
		addItem(new JoueurItem("25", "25","THOMAS M�LLER","FORWARD",R.drawable.small_mueller,R.drawable.big_mueller,"13 September 1989 in Weilheim","Virgo","-","1.86 m / 74 kg / 44","Married (partner Lisa)","Grammar school","Animals, golf, Schafskopf (a Bavarian card game)"));
	}
