...
public class ListViewSimple extends Activity implements OnItemClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        SimpleAdapter mSimpleAd = new SimpleAdapter(this, listItem, R.layout.one_article,
                new String[] {"Titre","Contenu"},
                new int[] {R.id.titreArticle, R.id.descArticle});
        maListViewPerso.setAdapter(mSimpleAd);
	...
	public void onItemClick(AdapterView<?> a, View v, int position, long id) {
        ...
        Toast.makeText(ListViewSimple.this, map.get("Titre"), Toast.LENGTH_LONG).show();
	}
